...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(38)
		::openfl::_v2::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)480,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::openfl::_v2::Lib_obj::HARDWARE) | int(::openfl::_v2::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::openfl::_v2::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("clicker"),null(),null());
	}
return null();
}
