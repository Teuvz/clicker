...
{
HX_STACK_FRAME("openfl._v2.filters.GlowFilter","new",0x1f11941b,"openfl._v2.filters.GlowFilter.new","openfl/_v2/filters/GlowFilter.hx",21,0x6e2dab52)
HX_STACK_THIS(this)
...
::openfl::_v2::filters::BitmapFilter GlowFilter_obj::clone( ){
	HX_STACK_FRAME("openfl._v2.filters.GlowFilter","clone",0xe4e57bd8,"openfl._v2.filters.GlowFilter.clone","openfl/_v2/filters/GlowFilter.hx",42,0x6e2dab52)
	HX_STACK_THIS(this)
	HX_STACK_LINE(42)
	return ::openfl::_v2::filters::GlowFilter_obj::__new(this->color,this->alpha,this->blurX,this->blurY,this->strength,this->quality,this->inner,this->knockout);
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.filters.GlowFilter"), hx::TCanCast< GlowFilter_obj> ,sStaticFields,sMemberFields,
