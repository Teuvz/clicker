...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(22)
		::openfl::_v2::Lib_obj::setPackage(HX_CSTRING("matt"),HX_CSTRING("clicker"),HX_CSTRING("com.ukuleledog.games.clicker.clicker"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","ApplicationMain.hx",38,0x0780ded5)
			{
				...
				HX_STACK_LINE(71)
				{
					...
					HX_STACK_LINE(71)
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::com::ukuleledog::games::clicker::Main >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(71)
					while(((_g < _g1->length))){
						HX_STACK_LINE(71)
				...
				if ((hasMain)){
					HX_STACK_LINE(84)
					::Reflect_obj::callMethod(hx::ClassOf< ::com::ukuleledog::games::clicker::Main >(),::Reflect_obj::field(hx::ClassOf< ::com::ukuleledog::games::clicker::Main >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(88)
		...
		HX_STACK_LINE(38)
		::openfl::_v2::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::openfl::_v2::Lib_obj::HARDWARE) | int(::openfl::_v2::Lib_obj::ALLOW_SHADERS))) | int(::openfl::_v2::Lib_obj::REQUIRE_SHADERS))) | int((int)0))) | int((int)0))) | int(::openfl::_v2::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int(::openfl::_v2::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("Je Suis Gros !"),null(),null());
	}
return null();
}
