...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("matt", "clicker", "com.ukuleledog.games.clicker.clicker", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (com.ukuleledog.games.clicker.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (com.ukuleledog.games.clicker.Main, Reflect.field (com.ukuleledog.games.clicker.Main, "main"), []);
...
@:keep class DocumentClass extends com.ukuleledog.games.clicker.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Je Suis Gros !", null, { width: 0, height: 0 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.ukuleledog.games.clicker.Main, []);
			}
...
import com.ukuleledog.games.clicker.Main;
