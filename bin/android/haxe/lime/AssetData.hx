...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("img/intro.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("img/special-1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("img/special-2.png", "img/special-2.png");
			type.set ("img/special-2.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("img/special-3.png", "img/special-3.png");
			type.set ("img/special-3.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("img/special-4.png", "img/special-4.png");
			type.set ("img/special-4.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("img/special-super.png", "img/special-super.png");
			type.set ("img/special-super.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("img/special.png", "img/special.png");
			type.set ("img/special.png", Reflect.field (AssetType, "image".toUpperCase ()));
